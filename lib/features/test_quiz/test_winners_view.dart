...
// MAIN WIDGET
// ─────────────────────────────────────────────
class TestWinnersView extends StatelessWidget {
  const TestWinnersView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final all = winners; // full leaderboard (winners + others)
    ...
    return Column(
      children: [
        // ── Header ──
        _buildHeader(theme, colors, isWinner, sorted.isEmpty),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No player reached the final answer.',
            textAlign: TextAlign.center,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (winner != null &&
                        (!winner.isWinner || winner.prize.isEmpty))
                      const SizedBox(height: 8),
                    ...
                    if (score != null)
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${KurdishFormat.digits(score)} pts',
                    ...
                    if (winner?.totalAnswerTimeMs != null) ...[
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${KurdishFormat.digits((winner!.totalAnswerTimeMs! / 1000).toStringAsFixed(1))} sec',
                            style: theme.textTheme.labelSmall?.copyWith(
                              color: colors.textMuted,
                              fontWeight: FontWeight.w600,
                              fontSize: 9.5,
                      ...
                      if (winner.score != null) ...[
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 2),
                            Text(
                              '${KurdishFormat.digits(winner.score!)} pts',
                              style: theme.textTheme.labelSmall?.copyWith(
                                color: colors.textMuted,
